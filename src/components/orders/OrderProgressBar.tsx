...
export const OrderProgressBar: FC<Props> = ({ status }) => {
    ...
    return (
        <Stack direction='row' width='100%' justifyContent='center' paddingTop={2.5}>
            ...
            <LinearProgress variant="determinate" value={getProgress(0)} sx={{ width: 100, marginTop: '18px' }} color='secondary' />
            <OrderStepIcon completed={step >= 1} description='Accepted' step={2} />
            <LinearProgress variant="determinate" value={getProgress(1)} sx={{ width: 100, marginTop: '18px' }} color='secondary' />
            <OrderStepIcon completed={step >= 2} description='Paid and in Production' step={3} />
            <LinearProgress variant="determinate" value={getProgress(2)} sx={{ width: 100, marginTop: '18px' }} color='secondary' />
            <OrderStepIcon completed={step >= 3} description='Shipped' step={4} />
            <LinearProgress variant="determinate" value={getProgress(3)} sx={{ width: 100, marginTop: '18px' }} color='secondary' />
