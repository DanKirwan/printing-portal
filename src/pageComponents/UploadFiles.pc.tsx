...
const UploadFilesPC: FC = () => {
    ...
    if (files.length == 0) return (
        <Stack height='100%' spacing={2} alignItems='center' justifyContent='center' sx={{ px: 10, py: 2 }} >
            <Stack flexGrow={1} justifyContent='center' maxWidth='80vh' alignItems='center' spacing={2}>

                <Stack sx={{ width: '100%', border: '1px dashed grey', borderRadius: 2, cursor: 'pointer' }} {...getRootProps()} spacing={5} paddingX={8} paddingY={6} alignItems='center' justifyContent='center'>
            ...
            <Typography textAlign='center' variant='caption'>
                ...
                <a href="mailto:order@henleyprint3d.com" style={{ color: 'red' }}>
            ...
            <Stack width='80%'>
                ...
                <Typography textAlign='center' variant='subtitle2' color='red'>
                    ...
                    Monday to Sunday. All requests answered within 24 hours.
